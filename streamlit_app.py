...
# Streamlit 제목
st.title("음원 성적 예측 서비스!")

# GitHub Raw 파일 URL과 모델 유형
GITHUB_RAW_URL = "https://github.com/theresonlyonebeerleft/spotify/raw/refs/heads/main/xgb_model.pkl"
MODEL_TYPE = "XGBoost"  # "fastai", "scikit-learn Random Forest", or "XGBoost"
CSV_FILE_URL = "https://github.com/theresonlyonebeerleft/spotify/raw/refs/heads/main/dataset.csv"
